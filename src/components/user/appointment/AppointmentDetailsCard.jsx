            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-between w-full gap-4">
                        ...
                        <span className="text-xl font-bold primaryColor">{formatPriceAbbreviated(propertyData.price)} <span class="text-sm font-normal">{propertyData?.property_type === "rent" && propertyData?.rentduration ? "/ " + propertyData?.rentduration : ""}</span></span>
                    </div>
                </div>
            </div>
        </div>
