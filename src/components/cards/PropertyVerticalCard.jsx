  ...
  return (
    ...
    >
      ...
      <div className="flex flex-grow flex-col">
        ...
        >
          <div class="flex flex-wrap items-center justify-center break-words gap-1">
            <span className="text-lg font-bold text-gray-900">
              {formatPriceAbbreviated(property.price)}
            </span>
            <span className="text-sm font-normal">{property?.property_type === "rent" && property?.rentduration ? "/ " + property?.rentduration : ""}</span>
          </div>
          {property.is_premium ? (
